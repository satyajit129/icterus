...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Asset Category</h1>
        <div>
            <ol class="breadcrumb">
        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('adminAssetCategoryCreateOrEdit') }}">
                                ...
                                <table class="table table-bordered text-nowrap border-bottom">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Asset Category</th>
                                            <th class="wd-15p border-bottom-0">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse($asset_categories as $key => $category)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $category->name  }}</td>
                                                <td>
                                                    <a href="{{ route('adminAssetCategoryCreateOrEdit', $category->id) }}"
                                                        class="btn btn-sm btn-primary" title="Edit"><i class="fe fe-edit"></i></a>

                                                    <a href="javascript:void(0);" class="btn btn-sm btn-danger delete-btn"
                                                        data-url="{{ route('adminAssetCategoryDelete', ['id' => $category->id]) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center">No Asset Category Found</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
