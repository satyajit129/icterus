            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('adminSalaryExpenseCreateOrEdit') }}">
                        <button type="button" class="btn btn-primary btn-sm"><i class="fe fe-plus me-2"></i>Add Salary Expense</button>
                    </a>
                </div>
                <div class="card-body">
                                ...
                                <table class="table table-bordered text-nowrap border-bottom">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Gross Salary</th>
                                            <th class="wd-15p border-bottom-0">Payable Month</th>
                                            <th class="wd-15p border-bottom-0">Working Days</th>
                                            <th class="wd-15p border-bottom-0">Festival Bonus</th>
                                            <th class="wd-15p border-bottom-0">Payable Amount</th>
                                        </tr>
                                    </thead>

                                    <tbody>
                                        @foreach ($salary_expenses as $salary_expense)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $salary_expense->id_number }}</td>
                                            <td>{{  }}</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
