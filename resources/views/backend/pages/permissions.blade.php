...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Admin Permission</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Admin Permission</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('adminPermissionCreateOrEdit') }}">
                                    ...
                                    <tbody>
                                        @forelse ($permissions as $permission)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('adminPermissionCreateOrEdit', $permission->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                                        <i class="fe fe-edit"></i>
                                                    </a>
                                                    <a href="javascript:void(0);" class="btn btn-sm btn-danger delete-btn"
                                                        data-url="{{ route('adminPermissionDelete', ['id' => $permission->id]) }}"
