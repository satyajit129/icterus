    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="{{ asset('uploads/' . $settings->logo) }}" class="header-brand-img desktop-logo" alt="logo"
                    style="width: 20%; margin-left: 20px;">
                <img src="{{ asset('uploads/' . $settings->logo) }}" class="header-brand-img toggle-logo" alt="logo"
                    style="width: 20%; margin-left: 20px;">
                <img src="{{ asset('uploads/' . $settings->logo) }}" class="header-brand-img light-logo" alt="logo"
                    style="width: 20%; margin-left: 20px;">
                <img src="{{ asset('uploads/' . $settings->logo) }}" class="header-brand-img light-logo1" alt="logo"
                    style="width: 20%; margin-left: 20px;">
            </a>
        ...
        <div class="main-sidemenu">
            ...
            @php
                $company_deals_routes = [
                    'adminCompanyDealsList',
                    'adminCompanyDealsView',
                    'adminCompanyDealsCreateOrEdit',
                    'adminDealsPayment',
                    'adminDealsPaymentCreateOrEdit',
                ];
                ...
                $incentive_routes = [
                    'adminIncentiveExpense',
                    'adminIncentiveExpenseCreateOrEdit',
                    'adminIncentiveExpenseView',
                ];
                $office_expense_routes = [
                    'adminOfficeExpense',
                    'adminOfficeExpenseCreateOrEdit',
                    'adminOfficeExpenseView',
                ];
                // $students_routes =
            ...
            <ul class="side-menu">
                ...
                @if ($canManageEarnings || $canManageSalesStatus)
                    ...
                    @if ($canManageEarnings)
                        <li class="slide {{ $is_earning_active ? 'is-expanded' : '' }}">
                            <a class="side-menu__item {{ $is_earning_active ? 'active' : '' }}" data-bs-toggle="slide"
                            ...
                            <ul class="slide-menu">
                                <li>
                                    <a href="{{ route('adminCompanyDealsList') }}"
                                        class="slide-item {{ $is_company_deals_active ? 'active' : '' }}">
                                        <i class="fe fe-briefcase me-2"></i> Company Deals
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('adminEarningList') }}"
                                        class="slide-item {{ $is_earning_route_active ? 'active' : '' }}">
                    ...
                    @if ($canManageSalesStatus)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminSalesStatus', 'adminSalesStatusCreateOrEdit') ? 'active' : '' }}"
                                href="{{ route('adminSalesStatus') }}">
                ...
                @if ($canManageExpense || $canManageExpenseCategory || $canManageLoan)
                    ...
                    @if ($canManageExpense)
                        <li class="slide {{ $is_expense_active ? 'is-expanded' : '' }}">
                            ...
                            <ul class="slide-menu">
                                <li>
                                    <a href="{{ route('adminSalaryExpense') }}"
                                        class="slide-item {{ $is_salary_active ? 'active' : '' }}">
                                        <i class="fe fe-credit-card me-2"></i> Salary
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('adminIncentiveExpense') }}"
                                        class="slide-item {{ $is_incentive_active ? 'active' : '' }}">
                                        <i class="fe fe-award me-2"></i> Incentives
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('adminOfficeExpense') }}"
                                        class="slide-item {{ $is_office_expense_active ? 'active' : '' }}">
                    ...
                    @if ($canManageLoan)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminLoanList', 'adminLoanCreateOrEdit') ? 'active' : '' }}"
                                href="{{ route('adminLoanList') }}">
                                <i class="side-menu__icon fe fe-file-text"></i>
                    ...
                    @if ($canManageExpenseCategory)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminExpenseCategory', 'adminExpenseCategoryCreateOrEdit') ? 'active' : '' }}"
                                href="{{ route('adminExpenseCategory') }}">
                    ...
                    @if ($canManageAsset)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminAssetCategory', 'adminAssetCategoryCreateOrEdit') ? 'active' : '' }}"
                                ...
                                <i class="side-menu__icon fe fe-tag"></i>
                                <span class="side-menu__label">Asset Category</span>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminAssetList', 'adminAssetCreateOrEdit') ? 'active' : '' }}"
                                href="{{ route('adminAssetList') }}">
                                <i class="side-menu__icon fe fe-tag"></i>
                ...
                @if ($canManageStudent)
                    ...
                    @if ($canManageStudent)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminStudentList', 'adminStudentCreateOrEdit', 'adminStudentPaymentList', 'adminStudentPaymentCreateOrEdit') ? 'active' : '' }}"
                ...
                @if ($canManageAdmin || $canManagePermission || $canManageRoleAccess)
                    ...
                    @if ($canManageRoleAccess)
                        <li class="slide">
                            <a class="side-menu__item has-link {{ Route::is('adminRoleAccess', 'adminRoleAccessCreateOrEdit') ? 'active' : '' }}"
